...
set(Qt5QuickShapes_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(_Qt5QuickShapes_OWN_INCLUDE_DIRS
      "${_qt5QuickShapes_install_prefix}/lib/QtQuickShapes.framework"
      "${_qt5QuickShapes_install_prefix}/lib/QtQuickShapes.framework/Headers"
    )
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/lib/QtQuickShapes.framework/Versions/5/Headers/5.15.13/"
        "${_qt5QuickShapes_install_prefix}/lib/QtQuickShapes.framework/Versions/5/Headers/5.15.13/QtQuickShapes"
    )
    ...
    foreach(_module_dep ${_Qt5QuickShapes_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5QuickShapes_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::QuickShapes PROPERTY FRAMEWORK 1)
    ...
    _populate_QuickShapes_target_properties(RELEASE "QtQuickShapes.framework/QtQuickShapes" "" TRUE)



    _populate_QuickShapes_target_properties(DEBUG "QtQuickShapes.framework/QtQuickShapes" "" TRUE)
