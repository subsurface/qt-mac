...
set(Qt5Test_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/lib/QtTest.framework/Versions/5/Headers/5.15.13/"
        "${_qt5Test_install_prefix}/lib/QtTest.framework/Versions/5/Headers/5.15.13/QtTest"
    )
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "QtTest.framework/QtTest" "" TRUE)



    _populate_Test_target_properties(DEBUG "QtTest.framework/QtTest" "" TRUE)
