...
set(Qt5QuickTest_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/lib/QtQuickTest.framework/Versions/5/Headers/5.15.13/"
        "${_qt5QuickTest_install_prefix}/lib/QtQuickTest.framework/Versions/5/Headers/5.15.13/QtQuickTest"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTest_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5QuickTest_FIND_VERSION_EXACT}
    ...
    _populate_QuickTest_target_properties(RELEASE "QtQuickTest.framework/QtQuickTest" "" TRUE)



    _populate_QuickTest_target_properties(DEBUG "QtQuickTest.framework/QtQuickTest" "" TRUE)
