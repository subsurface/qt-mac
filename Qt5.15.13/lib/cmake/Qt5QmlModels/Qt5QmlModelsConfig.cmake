...
set(Qt5QmlModels_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(_Qt5QmlModels_OWN_INCLUDE_DIRS
      "${_qt5QmlModels_install_prefix}/lib/QtQmlModels.framework"
      "${_qt5QmlModels_install_prefix}/lib/QtQmlModels.framework/Headers"
    )
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/lib/QtQmlModels.framework/Versions/5/Headers/5.15.13/"
        "${_qt5QmlModels_install_prefix}/lib/QtQmlModels.framework/Versions/5/Headers/5.15.13/QtQmlModels"
    )
    ...
    foreach(_module_dep ${_Qt5QmlModels_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5QmlModels_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::QmlModels PROPERTY FRAMEWORK 1)
    ...
    _populate_QmlModels_target_properties(RELEASE "QtQmlModels.framework/QtQmlModels" "" TRUE)



    _populate_QmlModels_target_properties(DEBUG "QtQmlModels.framework/QtQmlModels" "" TRUE)
