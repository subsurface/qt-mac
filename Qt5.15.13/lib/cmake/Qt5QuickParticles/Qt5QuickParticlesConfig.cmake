...
set(Qt5QuickParticles_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    set(_Qt5QuickParticles_OWN_INCLUDE_DIRS
      "${_qt5QuickParticles_install_prefix}/lib/QtQuickParticles.framework"
      "${_qt5QuickParticles_install_prefix}/lib/QtQuickParticles.framework/Headers"
    )
    set(Qt5QuickParticles_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickParticles_install_prefix}/lib/QtQuickParticles.framework/Versions/5/Headers/5.15.13/"
        "${_qt5QuickParticles_install_prefix}/lib/QtQuickParticles.framework/Versions/5/Headers/5.15.13/QtQuickParticles"
    )
    ...
    foreach(_module_dep ${_Qt5QuickParticles_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5QuickParticles_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::QuickParticles PROPERTY FRAMEWORK 1)
    ...
    _populate_QuickParticles_target_properties(RELEASE "QtQuickParticles.framework/QtQuickParticles" "" TRUE)



    _populate_QuickParticles_target_properties(DEBUG "QtQuickParticles.framework/QtQuickParticles" "" TRUE)
