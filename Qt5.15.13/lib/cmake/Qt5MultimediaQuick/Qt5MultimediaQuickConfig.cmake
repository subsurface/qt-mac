...
set(Qt5MultimediaQuick_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::MultimediaQuick)
    ...
    set(_Qt5MultimediaQuick_OWN_INCLUDE_DIRS
      "${_qt5MultimediaQuick_install_prefix}/lib/QtMultimediaQuick.framework"
      "${_qt5MultimediaQuick_install_prefix}/lib/QtMultimediaQuick.framework/Headers"
    )
    set(Qt5MultimediaQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaQuick_install_prefix}/lib/QtMultimediaQuick.framework/Versions/5/Headers/5.15.13/"
        "${_qt5MultimediaQuick_install_prefix}/lib/QtMultimediaQuick.framework/Versions/5/Headers/5.15.13/QtMultimediaQuick"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5MultimediaQuick_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::MultimediaQuick PROPERTY FRAMEWORK 1)
    ...
    _populate_MultimediaQuick_target_properties(RELEASE "QtMultimediaQuick.framework/QtMultimediaQuick" "" TRUE)



    _populate_MultimediaQuick_target_properties(DEBUG "QtMultimediaQuick.framework/QtMultimediaQuick" "" TRUE)
