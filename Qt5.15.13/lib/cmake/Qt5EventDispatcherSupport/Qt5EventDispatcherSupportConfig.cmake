...
set(Qt5EventDispatcherSupport_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    set(Qt5EventDispatcherSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EventDispatcherSupport_install_prefix}/include/QtEventDispatcherSupport/5.15.13"
        "${_qt5EventDispatcherSupport_install_prefix}/include/QtEventDispatcherSupport/5.15.13/QtEventDispatcherSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EventDispatcherSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5EventDispatcherSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_EventDispatcherSupport_process_prl_file(
            "${_qt5EventDispatcherSupport_install_prefix}/lib/libQt5EventDispatcherSupport_debug.prl" DEBUG
    ...
    _populate_EventDispatcherSupport_target_properties(RELEASE "libQt5EventDispatcherSupport.a" "" TRUE)



    _populate_EventDispatcherSupport_target_properties(DEBUG "libQt5EventDispatcherSupport_debug.a" "" TRUE)
