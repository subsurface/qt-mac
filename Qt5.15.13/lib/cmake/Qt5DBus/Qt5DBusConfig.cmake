...
set(Qt5DBus_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/lib/QtDBus.framework/Versions/5/Headers/5.15.13/"
        "${_qt5DBus_install_prefix}/lib/QtDBus.framework/Versions/5/Headers/5.15.13/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    _populate_DBus_target_properties(RELEASE "QtDBus.framework/QtDBus" "" TRUE)



    _populate_DBus_target_properties(DEBUG "QtDBus.framework/QtDBus" "" TRUE)
