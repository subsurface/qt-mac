...
set(Qt5OpenGL_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/lib/QtOpenGL.framework/Versions/5/Headers/5.15.13/"
        "${_qt5OpenGL_install_prefix}/lib/QtOpenGL.framework/Versions/5/Headers/5.15.13/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "QtOpenGL.framework/QtOpenGL" "" TRUE)



    _populate_OpenGL_target_properties(DEBUG "QtOpenGL.framework/QtOpenGL" "" TRUE)
