...
set(Qt5SerialBus_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/lib/QtSerialBus.framework/Versions/5/Headers/5.15.13/"
        "${_qt5SerialBus_install_prefix}/lib/QtSerialBus.framework/Versions/5/Headers/5.15.13/QtSerialBus"
    )
    ...
    foreach(_module_dep ${_Qt5SerialBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5SerialBus_FIND_VERSION_EXACT}
