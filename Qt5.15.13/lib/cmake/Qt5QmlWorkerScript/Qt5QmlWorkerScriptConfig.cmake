...
set(Qt5QmlWorkerScript_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/lib/QtQmlWorkerScript.framework/Versions/5/Headers/5.15.13/"
        "${_qt5QmlWorkerScript_install_prefix}/lib/QtQmlWorkerScript.framework/Versions/5/Headers/5.15.13/QtQmlWorkerScript"
    )
    ...
    foreach(_module_dep ${_Qt5QmlWorkerScript_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5QmlWorkerScript_FIND_VERSION_EXACT}
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "QtQmlWorkerScript.framework/QtQmlWorkerScript" "" TRUE)



    _populate_QmlWorkerScript_target_properties(DEBUG "QtQmlWorkerScript.framework/QtQmlWorkerScript" "" TRUE)
