...
set(Qt5Multimedia_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/lib/QtMultimedia.framework/Versions/5/Headers/5.15.13/"
        "${_qt5Multimedia_install_prefix}/lib/QtMultimedia.framework/Versions/5/Headers/5.15.13/QtMultimedia"
    )
    ...
    foreach(_module_dep ${_Qt5Multimedia_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5Multimedia_FIND_VERSION_EXACT}
    ...
    _populate_Multimedia_target_properties(RELEASE "QtMultimedia.framework/QtMultimedia" "" TRUE)



    _populate_Multimedia_target_properties(DEBUG "QtMultimedia.framework/QtMultimedia" "" TRUE)
