...
set(Qt5Help_VERSION_STRING 5.15.16)
...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/lib/QtHelp.framework/Versions/5/Headers/5.15.16/"
        "${_qt5Help_install_prefix}/lib/QtHelp.framework/Versions/5/Headers/5.15.16/QtHelp"
    )
    ...
    foreach(_module_dep ${_Qt5Help_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5Help_FIND_VERSION_EXACT}
    ...
    _populate_Help_target_properties(RELEASE "QtHelp.framework/QtHelp" "" TRUE)



    _populate_Help_target_properties(DEBUG "QtHelp.framework/QtHelp" "" TRUE)
