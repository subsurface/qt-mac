...
set(Qt5FontDatabaseSupport_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::FontDatabaseSupport)
    ...
    set(Qt5FontDatabaseSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FontDatabaseSupport_install_prefix}/include/QtFontDatabaseSupport/5.15.13"
        "${_qt5FontDatabaseSupport_install_prefix}/include/QtFontDatabaseSupport/5.15.13/QtFontDatabaseSupport"
    )
    ...
    foreach(_module_dep ${_Qt5FontDatabaseSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5FontDatabaseSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_FontDatabaseSupport_process_prl_file(
            "${_qt5FontDatabaseSupport_install_prefix}/lib/libQt5FontDatabaseSupport_debug.prl" DEBUG
    ...
    _populate_FontDatabaseSupport_target_properties(RELEASE "libQt5FontDatabaseSupport.a" "" TRUE)



    _populate_FontDatabaseSupport_target_properties(DEBUG "libQt5FontDatabaseSupport_debug.a" "" TRUE)
