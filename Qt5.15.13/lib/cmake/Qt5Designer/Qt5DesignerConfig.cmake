...
set(Qt5Designer_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::Designer)
    ...
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/lib/QtDesigner.framework/Versions/5/Headers/5.15.13/"
        "${_qt5Designer_install_prefix}/lib/QtDesigner.framework/Versions/5/Headers/5.15.13/QtDesigner"
    )
    ...
    foreach(_module_dep ${_Qt5Designer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5Designer_FIND_VERSION_EXACT}
    ...
    _populate_Designer_target_properties(RELEASE "QtDesigner.framework/QtDesigner" "" TRUE)



    _populate_Designer_target_properties(DEBUG "QtDesigner.framework/QtDesigner" "" TRUE)
