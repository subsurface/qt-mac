...
set(Qt5PlatformCompositorSupport_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    set(Qt5PlatformCompositorSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.15.13"
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.15.13/QtPlatformCompositorSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PlatformCompositorSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5PlatformCompositorSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_PlatformCompositorSupport_process_prl_file(
            "${_qt5PlatformCompositorSupport_install_prefix}/lib/libQt5PlatformCompositorSupport_debug.prl" DEBUG
    ...
    _populate_PlatformCompositorSupport_target_properties(RELEASE "libQt5PlatformCompositorSupport.a" "" TRUE)



    _populate_PlatformCompositorSupport_target_properties(DEBUG "libQt5PlatformCompositorSupport_debug.a" "" TRUE)
