...
set(Qt5UiTools_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.15.13"
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.15.13/QtUiTools"
    )
    ...
    foreach(_module_dep ${_Qt5UiTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5UiTools_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_UiTools_process_prl_file(
            "${_qt5UiTools_install_prefix}/lib/libQt5UiTools_debug.prl" DEBUG
    ...
    _populate_UiTools_target_properties(RELEASE "libQt5UiTools.a" "" TRUE)



    _populate_UiTools_target_properties(DEBUG "libQt5UiTools_debug.a" "" TRUE)
