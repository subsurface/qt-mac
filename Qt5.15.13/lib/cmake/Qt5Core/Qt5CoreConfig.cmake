...
set(Qt5Core_VERSION_STRING 5.15.13)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/lib/QtCore.framework/Versions/5/Headers/5.15.13/"
        "${_qt5Core_install_prefix}/lib/QtCore.framework/Versions/5/Headers/5.15.13/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    _populate_Core_target_properties(RELEASE "QtCore.framework/QtCore" "" TRUE)



    _populate_Core_target_properties(DEBUG "QtCore.framework/QtCore" "" TRUE)
